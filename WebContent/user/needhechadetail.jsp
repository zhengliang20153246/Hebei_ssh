...
<body style="background-color:#dceefc" onload= "javascript:document.getElementById( 'jiname').focus();">
	...
	<hr>
	<center>
	<form action="${pageContext.request.contextPath}/admin/xuqiuServlet?method=needxiugai&id=${zhengjibean.id }" method="post">
		...
		<br><br>
		<button type="button"  class="btn btn-primary" onclick='jiancha()'>修改并保存</button>
	</form>
	</center>
